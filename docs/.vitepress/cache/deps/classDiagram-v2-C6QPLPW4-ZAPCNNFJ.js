import {
  ...
  setNodeElem,
  updateNodeBounds
} from "./chunk-OHEOJKPX.js";
import {
  classDb_default,
  classDiagram_default,
  styles_default
} from "./chunk-JVXAIHQB.js";
import {
  write
} from "./chunk-46WQDLRU.js";
import {
  layout
} from "./chunk-FAU5WYCJ.js";
import {
  Graph
} from "./chunk-EEPTDJZS.js";
...
// node_modules/mermaid/dist/chunks/mermaid.core/classDiagram-v2-C6QPLPW4.mjs
var clusterDb = {};
var descendants = {};
var parents = {};
var clear3 = __name(() => {
...
var findNonClusterChild = __name((id, graph) => {
...
var extractor = __name((graph, depth) => {
  ...
  for (const node of nodes) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      if ((_b = (_a = clusterDb[node]) == null ? void 0 : _a.clusterData) == null ? void 0 : _b.dir) {
...
var roundedWithTitle = __name((parent, node) => {
  const siteConfig = getConfig2();
...
var clusterElems = {};
var insertCluster = __name((elem, node) => {
...
var render = __name(async (elem, graph, markers, diagramType, id) => {
...
var addNamespaces = __name(function(namespaces, g, _id, diagObj) {
  ...
  namespaces.forEach(function(vertex) {
    ...
    const node = {
      ...
      padding: ((_a = getConfig2().flowchart) == null ? void 0 : _a.padding) ?? ((_b = getConfig2().class) == null ? void 0 : _b.padding)
    };
...
var addClasses = __name(function(classes, g, _id, diagObj, parent) {
...
var addNotes = __name(function(notes, g, startEdgeId, classes) {
  log.info(notes);
...
var addRelations = __name(function(relations, g) {
  const conf2 = getConfig2().flowchart;
  let cnt = 0;
  relations.forEach(function(edge) {
    ...
    if (edge.text === void 0) {
      ...
      edgeData.arrowheadStyle = "fill: #333";
      edgeData.labelpos = "c";
      if (((_a = getConfig2().flowchart) == null ? void 0 : _a.htmlLabels) ?? getConfig2().htmlLabels) {
...
var draw = __name(async function(text, id, _version, diagObj) {
  ...
  const conf2 = getConfig2().flowchart ?? getConfig2().class;
  ...
  utils_default.insertTitle(svg, "classTitleText", (conf2 == null ? void 0 : conf2.titleTopMargin) ?? 5, diagObj.db.getDiagramTitle());
...
//# sourceMappingURL=classDiagram-v2-C6QPLPW4-ZAPCNNFJ.js.map
