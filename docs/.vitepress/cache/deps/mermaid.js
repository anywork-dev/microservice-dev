...
import {
  JSON_SCHEMA,
  load
} from "./chunk-QGAOIF6F.js";
import {
  registerLayoutLoaders
} from "./chunk-TZUTFYU2.js";
import "./chunk-KTQIQBVR.js";
import {
  registerIconPacks
} from "./chunk-HZ67BQ5N.js";
import "./chunk-PPFJUHEE.js";
import {
  dedent
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-ZCSEYPFN-EYIH6CWU.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-NWEUNK3L-GUIU75VE.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-DKC2X5TE-HNNDPN36.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-JPZ3KUXI-MYO3XZWV.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-HLVPPPRE-DOZHAB6Q.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-RZZSJVI2-AHZKKEOP.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-X7YZ5ZEZ-RAGEFGWV.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-F36EZAVT-HFMIWW2D.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-KECQ2H5Q-CS733TMH.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-JG2LMPGF-D2SKXOJ5.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-WK7YDQ3N-QJDJK4SA.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-Q73GJZWF-L3CXD7OH.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-C6QPLPW4-ZAPCNNFJ.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-4JV6CC6H-EBUO4LEQ.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-7KT6RKTD-OQMBTHPY.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-BLD6N6MZ-5PIPXKIU.js");
...
var draw = __name((_text, id25, version2) => {
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-3ZMEY6HS-M5M2MV27.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-OEB2RXX2-Y4MA2YBC.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-ATFNWWW6-BWQIO6HD.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-AVGMFHF7-UBU64FZJ.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-TCMKQVZ6-SAZL7WMT.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-IFBEXTG3-NIAQWYK7.js");
...
var appendDivSvgG = __name((parentRoot, id25, enclosingDivId, divStyle, svgXlink) => {
...
var removeExistingElements = __name((doc, id25, divId, iFrameId) => {
  var _a2, _b, _c;
  (_a2 = doc.getElementById(id25)) == null ? void 0 : _a2.remove();
  (_b = doc.getElementById(divId)) == null ? void 0 : _b.remove();
  (_c = doc.getElementById(iFrameId)) == null ? void 0 : _c.remove();
}, "removeExistingElements");
var render = __name(async function(id25, text, svgContainingElement) {
...
var render2 = __name((id25, text, container) => {
  return new Promise((resolve, reject) => {
    const performCall = __name(() => new Promise((res, rej) => {
